...
@useResult
$Res call({
 String id, String organizationId, String name, String? code, String? category, String? locationCity, String? locationState, String? address, InfraProjectStatus status, DateTime? startDate, DateTime? expectedEndDate, DateTime? actualEndDate, int progressPercent, int totalEstimatedCostPaise, int totalInvestmentPaise, int totalInvestmentReturnedPaise, int totalGovtSanctionedPaise, int totalGovtReceivedPaise, int totalExpensePaise, String? description, String? coverImageUrl, DateTime? createdAt, DateTime? updatedAt, DateTime? deletedAt
});
...
as int,totalInvestmentReturnedPaise: null == totalInvestmentReturnedPaise ? _self.totalInvestmentReturnedPaise : totalInvestmentReturnedPaise // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _InfraProject() when $default != null:
return $default(_that.id,_that.organizationId,_that.name,_that.code,_that.category,_that.locationCity,_that.locationState,_that.address,_that.status,_that.startDate,_that.expectedEndDate,_that.actualEndDate,_that.progressPercent,_that.totalEstimatedCostPaise,_that.totalInvestmentPaise,_that.totalInvestmentReturnedPaise,_that.totalGovtSanctionedPaise,_that.totalGovtReceivedPaise,_that.totalExpensePaise,_that.description,_that.coverImageUrl,_that.createdAt,_that.updatedAt,_that.deletedAt);case _:
  return orElse();
...
@override@JsonKey() final  int totalInvestmentReturnedPaise;
